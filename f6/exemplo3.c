...
- O valor co contador é analizado plea thread que executa a função main.
- Quando o valor atingir um determinado valor, a thread que execuuta a funcao main avança e faz terminar o programa



Situações de espera / Sinalização :

- A função que exeucta a função main é a função que agurada um acontecimento; esse acontecumento é o incremento do contador 
...
int main( int argc, char * argv[] ){
    ...
    //contador partilhado 
        ...
        // quando atingit o numero total de threads "inicial" avança 
    int prontas =0;
